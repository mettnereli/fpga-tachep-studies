...
set name dense_simple_mul_32s_32s_32_1_1
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename w \
    op interface \
    ports { w_address0 { O 7 vector } w_ce0 { O 1 bit } w_q0 { I 32 vector } w_address1 { O 7 vector } w_ce1 { O 1 bit } w_q1 { I 32 vector } } \
} "
} else {
...
set InstName dense_simple_flow_control_loop_pipe_sequential_init_U
set CompName dense_simple_flow_control_loop_pipe_sequential_init
set name flow_control_loop_pipe_sequential_init
if {${::AESL::PGuard_autocg_gen} && ${::AESL::PGuard_autocg_ipmgen}} {
if {[info proc ::AESL_LIB_VIRTEX::xil_gen_UPC_flow_control] == "::AESL_LIB_VIRTEX::xil_gen_UPC_flow_control"} {
eval "::AESL_LIB_VIRTEX::xil_gen_UPC_flow_control { \
    name ${name} \
    prefix dense_simple_ \
}"
} else {
