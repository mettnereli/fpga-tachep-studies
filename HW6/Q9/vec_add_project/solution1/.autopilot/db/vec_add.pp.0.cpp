...
typedef ap_uint<16> dint16_t;

__attribute__((sdx_kernel("vec_add", 0))) void vec_add(dint16_t A[15], dint16_t B[15], dint16_t C[15]);
# 2 "vec_add.cpp" 2

__attribute__((sdx_kernel("vec_add", 0))) void vec_add(dint16_t A[15], dint16_t B[15], dint16_t C[15]) {
#line 13 "/scratch/emettner/fpga-tachep-studies/HW6/Q9/run_vec_add.tcl"
#pragma HLSDIRECTIVE TOP name=vec_add
# 3 "vec_add.cpp"

    VITIS_LOOP_4_1: for (dint16_t i = 0; i < 15; i++) {
#pragma HLS UNROLL
 C[i] = A[i] + B[i];
