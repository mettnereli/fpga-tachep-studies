...
using hls::sim::Byte;
extern "C" void add_ap_fixed(Byte<2>*, Byte<2>*, Byte<2>*);
extern "C" void apatb_add_ap_fixed_hw(volatile void * __xlx_apatb_param_a, volatile void * __xlx_apatb_param_b, volatile void * __xlx_apatb_param_c) {
...
__xlx_c__tmp_vec.push_back(((Byte<2>*)__xlx_apatb_param_c)[i]);
  ...
  // DUT call
  add_ap_fixed(__xlx_a__tmp_vec.data(), __xlx_b__tmp_vec.data(), __xlx_c__tmp_vec.data());
