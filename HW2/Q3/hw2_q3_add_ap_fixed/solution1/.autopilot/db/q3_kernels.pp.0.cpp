...
void add_longlong(long long a[16], long long b[16], long long c[16]);
...
__attribute__((sdx_kernel("add_ap_fixed", 0))) void add_ap_fixed(ap_fixed<16,6> a[16], ap_fixed<16,6> b[16], ap_fixed<16,6> c[16]);
# 2 "q3_kernels.cpp" 2
...
#pragma HLSDIRECTIVE TOP name=add_ap_fixed
# 33 "q3_kernels.cpp"
