...
entity add_ap_fixed_flow_control_loop_pipe is
port (
    ap_clk             : in  std_logic;
    ap_rst             : in  std_logic;
...
end entity add_ap_fixed_flow_control_loop_pipe;

architecture behav of add_ap_fixed_flow_control_loop_pipe is
begin 
