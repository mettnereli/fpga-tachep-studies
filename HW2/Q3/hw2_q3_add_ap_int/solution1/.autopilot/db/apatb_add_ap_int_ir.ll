; ModuleID = '/scratch/emettner/fpga-tachep-studies/HW2/Q3/hw2_q3_add_ap_int/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_add_ap_int_ir(%"struct.ap_int<32>"* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="16" %a, %"struct.ap_int<32>"* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="16" %b, %"struct.ap_int<32>"* noalias nocapture nonnull "fpga.decayed.dim.hint"="16" %c) local_unnamed_addr #0 {
entry:
  ...
  call void @apatb_add_ap_int_hw([16 x i32]* %a_copy, [16 x i32]* %b_copy, [16 x i32]* %c_copy)
...
declare void @apatb_add_ap_int_hw([16 x i32]*, [16 x i32]*, [16 x i32]*)
...
define void @add_ap_int_hw_stub_wrapper([16 x i32]*, [16 x i32]*, [16 x i32]*) #5 {
entry:
  ...
  call void @add_ap_int_hw_stub(%"struct.ap_int<32>"* %6, %"struct.ap_int<32>"* %7, %"struct.ap_int<32>"* %8)
...
declare void @add_ap_int_hw_stub(%"struct.ap_int<32>"* noalias nocapture nonnull readonly, %"struct.ap_int<32>"* noalias nocapture nonnull readonly, %"struct.ap_int<32>"* noalias nocapture nonnull)
