...
// wrapc file define:
#define AUTOTB_TVIN_a "../tv/cdatafile/c.sorter.autotvin_a.dat"
#define AUTOTB_TVOUT_a "../tv/cdatafile/c.sorter.autotvout_a.dat"


// tvout file define:
#define AUTOTB_TVOUT_PC_a "../tv/rtldatafile/rtl.sorter.autotvout_a.dat"
...
extern "C"
void sorter_hw_stub_wrapper(void*);

extern "C"
void apatb_sorter_hw(void* __xlx_apatb_param_a)
{
#ifdef USE_BINARY_TV_FILE
  ...
  try {
    ...
    sorter_hw_stub_wrapper(__xlx_apatb_param_a);
