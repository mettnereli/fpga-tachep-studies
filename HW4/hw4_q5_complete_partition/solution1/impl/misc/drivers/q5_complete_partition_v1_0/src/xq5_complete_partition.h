...
// 
// ==============================================================
#ifndef XQ5_COMPLETE_PARTITION_H
#define XQ5_COMPLETE_PARTITION_H
...
#include <stddef.h>
#endif
#include "xq5_complete_partition_hw.h"
...
} XQ5_complete_partition_Config;
#endif

typedef struct {
    u64 Control_BaseAddress;
    u32 IsReady;
} XQ5_complete_partition;

typedef u32 word_type;

/***************** Macros (Inline Functions) Definitions *********************/
#ifndef __linux__
#define XQ5_complete_partition_WriteReg(BaseAddress, RegOffset, Data) \
    Xil_Out32((BaseAddress) + (RegOffset), (u32)(Data))
#define XQ5_complete_partition_ReadReg(BaseAddress, RegOffset) \
...
#else
int XQ5_complete_partition_Initialize(XQ5_complete_partition *InstancePtr, const char* InstanceName);
int XQ5_complete_partition_Release(XQ5_complete_partition *InstancePtr);
#endif
