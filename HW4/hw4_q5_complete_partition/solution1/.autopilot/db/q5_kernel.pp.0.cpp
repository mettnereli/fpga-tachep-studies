...
void q5_interface(int A[64], int B[64],
                  int C[64], int D[64], int E[64]);
...
__attribute__((sdx_kernel("q5_complete_partition", 0))) void q5_complete_partition(int A[64], int B[64],
                           int C[64], int D[64], int E[64]);
...
#pragma HLSDIRECTIVE TOP name=q5_complete_partition
# 76 "q5_kernel.cpp"
