; ModuleID = '/scratch/emettner/fpga-tachep-studies/HW4/hw4_q5_no_partition/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
source_filename = "llvm-link"
target datalayout = "e-m:e-i64:64-i128:128-i256:256-i512:512-i1024:1024-i2048:2048-i4096:4096-n8:16:32:64-S128-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024"
target triple = "fpga64-xilinx-none"

; Function Attrs: inaccessiblemem_or_argmemonly noinline willreturn
define void @apatb_q5_no_partition_ir(i32* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="64" %A, i32* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="64" %B, i32* noalias nocapture nonnull "fpga.decayed.dim.hint"="64" %C, i32* noalias nocapture nonnull "fpga.decayed.dim.hint"="64" %D, i32* noalias nocapture nonnull "fpga.decayed.dim.hint"="64" %E) local_unnamed_addr #0 {
entry:
  ...
  call void @apatb_q5_no_partition_hw([64 x i32]* %A_copy, [64 x i32]* %B_copy, [64 x i32]* %C_copy, [64 x i32]* %D_copy, [64 x i32]* %E_copy)
...
declare void @apatb_q5_no_partition_hw([64 x i32]*, [64 x i32]*, [64 x i32]*, [64 x i32]*, [64 x i32]*)
...
define void @q5_no_partition_hw_stub_wrapper([64 x i32]*, [64 x i32]*, [64 x i32]*, [64 x i32]*, [64 x i32]*) #5 {
entry:
  ...
  call void @q5_no_partition_hw_stub(i32* %5, i32* %6, i32* %7, i32* %8, i32* %9)
...
declare void @q5_no_partition_hw_stub(i32* noalias nocapture nonnull readonly, i32* noalias nocapture nonnull readonly, i32* noalias nocapture nonnull, i32* noalias nocapture nonnull, i32* noalias nocapture nonnull)
