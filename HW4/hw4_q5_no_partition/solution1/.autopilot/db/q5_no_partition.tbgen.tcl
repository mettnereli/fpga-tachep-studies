set moduleName q5_no_partition
set isTopModule 1
...
set C_modelName {q5_no_partition}
...
dict set ap_memory_interface_dict C { MEM_WIDTH 32 MEM_SIZE 256 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
dict set ap_memory_interface_dict D { MEM_WIDTH 32 MEM_SIZE 256 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
dict set ap_memory_interface_dict E { MEM_WIDTH 32 MEM_SIZE 256 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
set C_modelArgList {
	{ A int 32 regular {array 64 { 1 1 } 1 1 }  }
	{ B int 32 regular {array 64 { 1 1 } 1 1 }  }
	{ C int 32 regular {array 64 { 0 0 } 0 1 }  }
	{ D int 32 regular {array 64 { 0 0 } 0 1 }  }
	{ E int 32 regular {array 64 { 0 0 } 0 1 }  }
}
set hasAXIMCache 0
...
set portList { 
	...
	{ D_d0 sc_out sc_lv 32 signal 3 } 
	{ D_address1 sc_out sc_lv 6 signal 3 } 
	{ D_ce1 sc_out sc_logic 1 signal 3 } 
	{ D_we1 sc_out sc_logic 1 signal 3 } 
	{ D_d1 sc_out sc_lv 32 signal 3 } 
	{ E_address0 sc_out sc_lv 6 signal 4 } 
	{ E_ce0 sc_out sc_logic 1 signal 4 } 
	{ E_we0 sc_out sc_logic 1 signal 4 } 
	{ E_d0 sc_out sc_lv 32 signal 4 } 
	{ E_address1 sc_out sc_lv 6 signal 4 } 
	{ E_ce1 sc_out sc_logic 1 signal 4 } 
	{ E_we1 sc_out sc_logic 1 signal 4 } 
	{ E_d1 sc_out sc_lv 32 signal 4 } 
...
set NewPortList {[ 
	{ "name": "s_axi_control_AWADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "control", "role": "AWADDR" },"address":[{"name":"q5_no_partition","role":"start","value":"0","valid_bit":"0"},{"name":"q5_no_partition","role":"continue","value":"0","valid_bit":"4"},{"name":"q5_no_partition","role":"auto_start","value":"0","valid_bit":"7"}] },
	...
	{ "name": "s_axi_control_ARADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "control", "role": "ARADDR" },"address":[{"name":"q5_no_partition","role":"start","value":"0","valid_bit":"0"},{"name":"q5_no_partition","role":"done","value":"0","valid_bit":"1"},{"name":"q5_no_partition","role":"idle","value":"0","valid_bit":"2"},{"name":"q5_no_partition","role":"ready","value":"0","valid_bit":"3"},{"name":"q5_no_partition","role":"auto_start","value":"0","valid_bit":"7"}] },
	...
	{ "name": "interrupt", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "control", "role": "interrupt" } }, 
 	...
 	{ "name": "D_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "D", "role": "address1" }} , 
 	...
 	{ "name": "E_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "E", "role": "address0" }} , 
 	...
 	{ "name": "E_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "E", "role": "address1" }} , 
 	...
 	{ "name": "E_d1", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "E", "role": "d1" }}  ]}

set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3", "4", "5", "6"],
		"CDFG" : "q5_no_partition",
		"Protocol" : "ap_ctrl_hs",
...
set ArgLastReadFirstWriteLatency {
	q5_no_partition {
		...
		E {Type O LastRead -1 FirstWrite 1}}}
...
set Spec2ImplPortList { 
	...
	C { ap_memory {  { C_address0 mem_address 1 6 }  { C_ce0 mem_ce 1 1 }  { C_we0 mem_we 1 1 }  { C_d0 mem_din 1 32 }  { C_address1 MemPortADDR2 1 6 }  { C_ce1 MemPortCE2 1 1 }  { C_we1 MemPortWE2 1 1 }  { C_d1 MemPortDIN2 1 32 } } }
	D { ap_memory {  { D_address0 mem_address 1 6 }  { D_ce0 mem_ce 1 1 }  { D_we0 mem_we 1 1 }  { D_d0 mem_din 1 32 }  { D_address1 MemPortADDR2 1 6 }  { D_ce1 MemPortCE2 1 1 }  { D_we1 MemPortWE2 1 1 }  { D_d1 MemPortDIN2 1 32 } } }
	E { ap_memory {  { E_address0 mem_address 1 6 }  { E_ce0 mem_ce 1 1 }  { E_we0 mem_we 1 1 }  { E_d0 mem_din 1 32 }  { E_address1 MemPortADDR2 1 6 }  { E_ce1 MemPortCE2 1 1 }  { E_we1 MemPortWE2 1 1 }  { E_d1 MemPortDIN2 1 32 } } }
}
