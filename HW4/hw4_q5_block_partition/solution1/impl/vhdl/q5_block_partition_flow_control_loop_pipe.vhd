...
entity q5_block_partition_flow_control_loop_pipe is
port (
    ap_clk             : in  std_logic;
    ap_rst             : in  std_logic;
...
end entity q5_block_partition_flow_control_loop_pipe;

architecture behav of q5_block_partition_flow_control_loop_pipe is
begin 
