; ModuleID = '/scratch/emettner/fpga-tachep-studies/HW4/hw4_q5_block_partition/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_q5_block_partition_ir(i32* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="64" "partition" %A, i32* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="64" "partition" %B, i32* noalias nocapture nonnull "fpga.decayed.dim.hint"="64" "partition" %C, i32* noalias nocapture nonnull "fpga.decayed.dim.hint"="64" "partition" %D, i32* noalias nocapture nonnull "fpga.decayed.dim.hint"="64" "partition" %E) local_unnamed_addr #1 {
entry:
  ...
  call void @apatb_q5_block_partition_hw([16 x i32]* %A_copy_0, [16 x i32]* %A_copy_1, [16 x i32]* %A_copy_2, [16 x i32]* %A_copy_3, [16 x i32]* %B_copy_0, [16 x i32]* %B_copy_1, [16 x i32]* %B_copy_2, [16 x i32]* %B_copy_3, [16 x i32]* %C_copy_0, [16 x i32]* %C_copy_1, [16 x i32]* %C_copy_2, [16 x i32]* %C_copy_3, [16 x i32]* %D_copy_0, [16 x i32]* %D_copy_1, [16 x i32]* %D_copy_2, [16 x i32]* %D_copy_3, [16 x i32]* %E_copy_0, [16 x i32]* %E_copy_1, [16 x i32]* %E_copy_2, [16 x i32]* %E_copy_3)
...
for.loop:                                         ; preds = %dst.addr.exit, %for.loop.lr.ph
  ...
  %3 = urem i64 %for.loop.idx2, 16
  %4 = udiv i64 %for.loop.idx2, 16
...
dst.addr.case.3:                                  ; preds = %for.loop
  %6 = and i64 %for.loop.idx2, 9223372036854775792
  %7 = icmp eq i64 %6, 48
...
src.addr.case.3:                                  ; preds = %for.loop
  %5 = and i64 %for.loop.idx2, 9223372036854775792
  %6 = icmp eq i64 %5, 48
...
src.addr.exit:                                    ; preds = %src.addr.case.3, %src.addr.case.2, %src.addr.case.1, %src.addr.case.0
  %7 = phi i32 [ %_0, %src.addr.case.0 ], [ %_1, %src.addr.case.1 ], [ %_2, %src.addr.case.2 ], [ %_3, %src.addr.case.3 ]
...
declare void @apatb_q5_block_partition_hw([16 x i32]*, [16 x i32]*, [16 x i32]*, [16 x i32]*, [16 x i32]*, [16 x i32]*, [16 x i32]*, [16 x i32]*, [16 x i32]*, [16 x i32]*, [16 x i32]*, [16 x i32]*, [16 x i32]*, [16 x i32]*, [16 x i32]*, [16 x i32]*, [16 x i32]*, [16 x i32]*, [16 x i32]*, [16 x i32]*)
...
define void @q5_block_partition_hw_stub_wrapper([16 x i32]*, [16 x i32]*, [16 x i32]*, [16 x i32]*, [16 x i32]*, [16 x i32]*, [16 x i32]*, [16 x i32]*, [16 x i32]*, [16 x i32]*, [16 x i32]*, [16 x i32]*, [16 x i32]*, [16 x i32]*, [16 x i32]*, [16 x i32]*, [16 x i32]*, [16 x i32]*, [16 x i32]*, [16 x i32]*) #7 {
entry:
  %20 = alloca [64 x i32]
  %21 = alloca [64 x i32]
  %22 = alloca [64 x i32]
  ...
  call void @q5_block_partition_hw_stub(i32* %25, i32* %26, i32* %27, i32* %28, i32* %29)
  call void @copy_in([64 x i32]* %20, [16 x i32]* %0, [16 x i32]* %1, [16 x i32]* %2, [16 x i32]* %3, [64 x i32]* %21, [16 x i32]* %4, [16 x i32]* %5, [16 x i32]* %6, [16 x i32]* %7, [64 x i32]* %22, [16 x i32]* %8, [16 x i32]* %9, [16 x i32]* %10, [16 x i32]* %11, [64 x i32]* %23, [16 x i32]* %12, [16 x i32]* %13, [16 x i32]* %14, [16 x i32]* %15, [64 x i32]* %24, [16 x i32]* %16, [16 x i32]* %17, [16 x i32]* %18, [16 x i32]* %19)
  ret void
}

declare void @q5_block_partition_hw_stub(i32* noalias nocapture nonnull readonly, i32* noalias nocapture nonnull readonly, i32* noalias nocapture nonnull, i32* noalias nocapture nonnull, i32* noalias nocapture nonnull)
...
!47 = !DILocation(line: 138, column: 9, scope: !48)
!48 = distinct !DISubprogram(name: "q5_block_partition", linkageName: "_Z18q5_block_partitionPiS_S_S_S_", scope: !49, file: !49, line: 129, type: !50, isLocal: false, isDefinition: true, scopeLine: 130, flags: DIFlagPrototyped, isOptimized: false, unit: !54, variables: !4)
...
!55 = !DIFile(filename: "/scratch/emettner/fpga-tachep-studies/HW4/hw4_q5_block_partition/solution1/.autopilot/db/q5_kernel.pp.0.cpp", directory: "/scratch/emettner/fpga-tachep-studies/HW4")
!56 = !DILocation(line: 139, column: 9, scope: !48)
!57 = !DILocation(line: 140, column: 9, scope: !48)
!58 = !DILocation(line: 141, column: 9, scope: !48)
!59 = !DILocation(line: 142, column: 9, scope: !48)
