...
using hls::sim::Byte;
extern "C" void q5_block_partition(Byte<4>*, Byte<4>*, Byte<4>*, Byte<4>*, Byte<4>*, Byte<4>*, Byte<4>*, Byte<4>*, Byte<4>*, Byte<4>*, Byte<4>*, Byte<4>*, Byte<4>*, Byte<4>*, Byte<4>*, Byte<4>*, Byte<4>*, Byte<4>*, Byte<4>*, Byte<4>*);
extern "C" void apatb_q5_block_partition_hw(volatile void * __xlx_apatb_param_A_0, volatile void * __xlx_apatb_param_A_1, volatile void * __xlx_apatb_param_A_2, volatile void * __xlx_apatb_param_A_3, volatile void * __xlx_apatb_param_B_0, volatile void * __xlx_apatb_param_B_1, volatile void * __xlx_apatb_param_B_2, volatile void * __xlx_apatb_param_B_3, volatile void * __xlx_apatb_param_C_0, volatile void * __xlx_apatb_param_C_1, volatile void * __xlx_apatb_param_C_2, volatile void * __xlx_apatb_param_C_3, volatile void * __xlx_apatb_param_D_0, volatile void * __xlx_apatb_param_D_1, volatile void * __xlx_apatb_param_D_2, volatile void * __xlx_apatb_param_D_3, volatile void * __xlx_apatb_param_E_0, volatile void * __xlx_apatb_param_E_1, volatile void * __xlx_apatb_param_E_2, volatile void * __xlx_apatb_param_E_3) {
...
__xlx_D_1__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_D_1)[i]);
  ...
  int __xlx_size_param_D_1 = 16;
  int __xlx_offset_param_D_1 = 0;
  int __xlx_offset_byte_param_D_1 = 0*4;
  // Collect __xlx_D_2__tmp_vec
std::vector<Byte<4>> __xlx_D_2__tmp_vec;
for (size_t i = 0; i < 16; ++i){
__xlx_D_2__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_D_2)[i]);
}
  int __xlx_size_param_D_2 = 16;
  int __xlx_offset_param_D_2 = 0;
  int __xlx_offset_byte_param_D_2 = 0*4;
  // Collect __xlx_D_3__tmp_vec
std::vector<Byte<4>> __xlx_D_3__tmp_vec;
for (size_t i = 0; i < 16; ++i){
__xlx_D_3__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_D_3)[i]);
}
  int __xlx_size_param_D_3 = 16;
  int __xlx_offset_param_D_3 = 0;
  int __xlx_offset_byte_param_D_3 = 0*4;
  // Collect __xlx_E_0__tmp_vec
std::vector<Byte<4>> __xlx_E_0__tmp_vec;
for (size_t i = 0; i < 16; ++i){
__xlx_E_0__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_E_0)[i]);
}
  int __xlx_size_param_E_0 = 16;
  int __xlx_offset_param_E_0 = 0;
  int __xlx_offset_byte_param_E_0 = 0*4;
  // Collect __xlx_E_1__tmp_vec
std::vector<Byte<4>> __xlx_E_1__tmp_vec;
for (size_t i = 0; i < 16; ++i){
__xlx_E_1__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_E_1)[i]);
}
  int __xlx_size_param_E_1 = 16;
  int __xlx_offset_param_E_1 = 0;
  int __xlx_offset_byte_param_E_1 = 0*4;
  // Collect __xlx_E_2__tmp_vec
std::vector<Byte<4>> __xlx_E_2__tmp_vec;
for (size_t i = 0; i < 16; ++i){
__xlx_E_2__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_E_2)[i]);
}
  int __xlx_size_param_E_2 = 16;
  int __xlx_offset_param_E_2 = 0;
  int __xlx_offset_byte_param_E_2 = 0*4;
  // Collect __xlx_E_3__tmp_vec
std::vector<Byte<4>> __xlx_E_3__tmp_vec;
for (size_t i = 0; i < 16; ++i){
__xlx_E_3__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_E_3)[i]);
}
  int __xlx_size_param_E_3 = 16;
  int __xlx_offset_param_E_3 = 0;
  int __xlx_offset_byte_param_E_3 = 0*4;
  // DUT call
  q5_block_partition(__xlx_A_0__tmp_vec.data(), __xlx_A_1__tmp_vec.data(), __xlx_A_2__tmp_vec.data(), __xlx_A_3__tmp_vec.data(), __xlx_B_0__tmp_vec.data(), __xlx_B_1__tmp_vec.data(), __xlx_B_2__tmp_vec.data(), __xlx_B_3__tmp_vec.data(), __xlx_C_0__tmp_vec.data(), __xlx_C_1__tmp_vec.data(), __xlx_C_2__tmp_vec.data(), __xlx_C_3__tmp_vec.data(), __xlx_D_0__tmp_vec.data(), __xlx_D_1__tmp_vec.data(), __xlx_D_2__tmp_vec.data(), __xlx_D_3__tmp_vec.data(), __xlx_E_0__tmp_vec.data(), __xlx_E_1__tmp_vec.data(), __xlx_E_2__tmp_vec.data(), __xlx_E_3__tmp_vec.data());
...
for (size_t i = 0; i < __xlx_size_param_D_2; ++i) {
((Byte<4>*)__xlx_apatb_param_D_2)[i] = __xlx_D_2__tmp_vec[__xlx_offset_param_D_2+i];
}
// print __xlx_apatb_param_D_3
for (size_t i = 0; i < __xlx_size_param_D_3; ++i) {
((Byte<4>*)__xlx_apatb_param_D_3)[i] = __xlx_D_3__tmp_vec[__xlx_offset_param_D_3+i];
}
// print __xlx_apatb_param_E_0
for (size_t i = 0; i < __xlx_size_param_E_0; ++i) {
((Byte<4>*)__xlx_apatb_param_E_0)[i] = __xlx_E_0__tmp_vec[__xlx_offset_param_E_0+i];
}
// print __xlx_apatb_param_E_1
for (size_t i = 0; i < __xlx_size_param_E_1; ++i) {
((Byte<4>*)__xlx_apatb_param_E_1)[i] = __xlx_E_1__tmp_vec[__xlx_offset_param_E_1+i];
}
// print __xlx_apatb_param_E_2
for (size_t i = 0; i < __xlx_size_param_E_2; ++i) {
((Byte<4>*)__xlx_apatb_param_E_2)[i] = __xlx_E_2__tmp_vec[__xlx_offset_param_E_2+i];
}
// print __xlx_apatb_param_E_3
for (size_t i = 0; i < __xlx_size_param_E_3; ++i) {
((Byte<4>*)__xlx_apatb_param_E_3)[i] = __xlx_E_3__tmp_vec[__xlx_offset_param_E_3+i];
}
}
