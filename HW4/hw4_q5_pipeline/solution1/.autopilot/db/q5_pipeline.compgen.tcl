...
set name q5_pipeline_mul_32s_32s_32_1_1
...
if {${::AESL::PGuard_simmodel_gen}} {
	if {[info proc ::AESL_LIB_XILADAPTER::s_axilite_gen] == "::AESL_LIB_XILADAPTER::s_axilite_gen"} {
		eval "::AESL_LIB_XILADAPTER::s_axilite_gen { \
			id 4 \
			corename q5_pipeline_control_axilite \
			name q5_pipeline_control_s_axi \
			ports {$port_control} \
			op interface \
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler q5_pipeline_control_s_axi BINDTYPE interface TYPE interface_s_axilite
}
...
set InstName q5_pipeline_flow_control_loop_pipe_U
set CompName q5_pipeline_flow_control_loop_pipe
