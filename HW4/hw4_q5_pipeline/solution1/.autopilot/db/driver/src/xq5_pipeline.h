...
// 
// ==============================================================
#ifndef XQ5_PIPELINE_H
#define XQ5_PIPELINE_H
...
#ifndef __linux__
#define XQ5_pipeline_WriteReg(BaseAddress, RegOffset, Data) \
    Xil_Out32((BaseAddress) + (RegOffset), (u32)(Data))
#define XQ5_pipeline_ReadReg(BaseAddress, RegOffset) \
...
#else
int XQ5_pipeline_Initialize(XQ5_pipeline *InstancePtr, const char* InstanceName);
int XQ5_pipeline_Release(XQ5_pipeline *InstancePtr);
#endif
