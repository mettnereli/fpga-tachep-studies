...
set C_modelArgList {
	...
	{ C int 32 regular {array 64 { 0 3 } 0 1 }  }
	{ D int 32 regular {array 64 { 0 3 } 0 1 }  }
	{ E int 32 regular {array 64 { 0 3 } 0 1 }  }
}
set hasAXIMCache 0
...
set NewPortList {[ 
	{ "name": "s_axi_control_AWADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "control", "role": "AWADDR" },"address":[{"name":"q5_pipeline","role":"start","value":"0","valid_bit":"0"},{"name":"q5_pipeline","role":"continue","value":"0","valid_bit":"4"},{"name":"q5_pipeline","role":"auto_start","value":"0","valid_bit":"7"}] },
	...
	{ "name": "s_axi_control_ARADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "control", "role": "ARADDR" },"address":[{"name":"q5_pipeline","role":"start","value":"0","valid_bit":"0"},{"name":"q5_pipeline","role":"done","value":"0","valid_bit":"1"},{"name":"q5_pipeline","role":"idle","value":"0","valid_bit":"2"},{"name":"q5_pipeline","role":"ready","value":"0","valid_bit":"3"},{"name":"q5_pipeline","role":"auto_start","value":"0","valid_bit":"7"}] },
...
set Spec2ImplPortList { 
	...
	D { ap_memory {  { D_address0 mem_address 1 6 }  { D_ce0 mem_ce 1 1 }  { D_we0 mem_we 1 1 }  { D_d0 mem_din 1 32 } } }
	E { ap_memory {  { E_address0 mem_address 1 6 }  { E_ce0 mem_ce 1 1 }  { E_we0 mem_we 1 1 }  { E_d0 mem_din 1 32 } } }
}
