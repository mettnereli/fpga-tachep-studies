...
using hls::sim::Byte;
extern "C" void q5_pipeline(Byte<4>*, Byte<4>*, Byte<4>*, Byte<4>*, Byte<4>*);
extern "C" void apatb_q5_pipeline_hw(volatile void * __xlx_apatb_param_A, volatile void * __xlx_apatb_param_B, volatile void * __xlx_apatb_param_C, volatile void * __xlx_apatb_param_D, volatile void * __xlx_apatb_param_E) {
...
__xlx_E__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_E)[i]);
  ...
  // DUT call
  q5_pipeline(__xlx_A__tmp_vec.data(), __xlx_B__tmp_vec.data(), __xlx_C__tmp_vec.data(), __xlx_D__tmp_vec.data(), __xlx_E__tmp_vec.data());
