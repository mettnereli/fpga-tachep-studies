...
set name q5_cyclic_partition_mul_32s_32s_32_1_1
...
if {${::AESL::PGuard_simmodel_gen}} {
	if {[info proc ::AESL_LIB_XILADAPTER::s_axilite_gen] == "::AESL_LIB_XILADAPTER::s_axilite_gen"} {
		eval "::AESL_LIB_XILADAPTER::s_axilite_gen { \
			id 10 \
			corename q5_cyclic_partition_control_axilite \
			name q5_cyclic_partition_control_s_axi \
			ports {$port_control} \
			op interface \
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler q5_cyclic_partition_control_s_axi BINDTYPE interface TYPE interface_s_axilite
}
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename D_0 \
    op interface \
    ports { D_0_address0 { O 4 vector } D_0_ce0 { O 1 bit } D_0_we0 { O 1 bit } D_0_d0 { O 32 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename E_0 \
    op interface \
    ports { E_0_address0 { O 4 vector } E_0_ce0 { O 1 bit } E_0_we0 { O 1 bit } E_0_d0 { O 32 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename E_1 \
    op interface \
    ports { E_1_address0 { O 4 vector } E_1_ce0 { O 1 bit } E_1_we0 { O 1 bit } E_1_d0 { O 32 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename E_2 \
    op interface \
    ports { E_2_address0 { O 4 vector } E_2_ce0 { O 1 bit } E_2_we0 { O 1 bit } E_2_d0 { O 32 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename E_3 \
    op interface \
    ports { E_3_address0 { O 4 vector } E_3_ce0 { O 1 bit } E_3_we0 { O 1 bit } E_3_d0 { O 32 vector } } \
} "
} else {
...
set InstName q5_cyclic_partition_flow_control_loop_pipe_U
set CompName q5_cyclic_partition_flow_control_loop_pipe
set name flow_control_loop_pipe
if {${::AESL::PGuard_autocg_gen} && ${::AESL::PGuard_autocg_ipmgen}} {
if {[info proc ::AESL_LIB_VIRTEX::xil_gen_UPC_flow_control] == "::AESL_LIB_VIRTEX::xil_gen_UPC_flow_control"} {
eval "::AESL_LIB_VIRTEX::xil_gen_UPC_flow_control { \
    name ${name} \
    prefix q5_cyclic_partition_ \
}"
} else {
