set moduleName vector_multiply
set isTopModule 1
...
set C_modelName {vector_multiply}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
dict set ap_memory_interface_dict A { MEM_WIDTH 32 MEM_SIZE 40 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
...
dict set ap_memory_interface_dict C { MEM_WIDTH 32 MEM_SIZE 40 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
set C_modelArgList {
	{ A int 32 regular {array 10 { 1 3 } 1 1 }  }
	{ B int 32 regular {array 10 { 1 3 } 1 1 }  }
	{ C int 32 regular {array 10 { 0 3 } 0 1 }  }
}
set hasAXIMCache 0
