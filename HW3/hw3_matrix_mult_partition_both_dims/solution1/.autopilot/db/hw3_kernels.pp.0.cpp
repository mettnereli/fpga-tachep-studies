...
void vector_mult_partition(int a[16], int b[16], int c[16]);
...
__attribute__((sdx_kernel("matrix_mult_partition_both_dims", 0))) void matrix_mult_partition_both_dims(
    int A[6][6],
    int B[6][6],
    int C[6][6]
);
...
#pragma HLSDIRECTIVE TOP name=matrix_mult_partition_both_dims
# 80 "hw3_kernels.cpp"
