...
using hls::sim::Byte;
extern "C" void matrix_mult_partition_one_dim(Byte<4>*, Byte<4>*, Byte<4>*, Byte<4>*, Byte<4>*, Byte<4>*, Byte<4>*, Byte<4>*, Byte<4>*, Byte<4>*, Byte<4>*, Byte<4>*, Byte<4>*);
extern "C" void apatb_matrix_mult_partition_one_dim_hw(volatile void * __xlx_apatb_param_A_0, volatile void * __xlx_apatb_param_A_1, volatile void * __xlx_apatb_param_A_2, volatile void * __xlx_apatb_param_A_3, volatile void * __xlx_apatb_param_A_4, volatile void * __xlx_apatb_param_A_5, volatile void * __xlx_apatb_param_B_0, volatile void * __xlx_apatb_param_B_1, volatile void * __xlx_apatb_param_B_2, volatile void * __xlx_apatb_param_B_3, volatile void * __xlx_apatb_param_B_4, volatile void * __xlx_apatb_param_B_5, volatile void * __xlx_apatb_param_C) {
...
__xlx_C__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_C)[i]);
  ...
  int __xlx_size_param_C = 36;
  int __xlx_offset_param_C = 0;
  int __xlx_offset_byte_param_C = 0*4;
  // DUT call
  matrix_mult_partition_one_dim(__xlx_A_0__tmp_vec.data(), __xlx_A_1__tmp_vec.data(), __xlx_A_2__tmp_vec.data(), __xlx_A_3__tmp_vec.data(), __xlx_A_4__tmp_vec.data(), __xlx_A_5__tmp_vec.data(), __xlx_B_0__tmp_vec.data(), __xlx_B_1__tmp_vec.data(), __xlx_B_2__tmp_vec.data(), __xlx_B_3__tmp_vec.data(), __xlx_B_4__tmp_vec.data(), __xlx_B_5__tmp_vec.data(), __xlx_C__tmp_vec.data());
