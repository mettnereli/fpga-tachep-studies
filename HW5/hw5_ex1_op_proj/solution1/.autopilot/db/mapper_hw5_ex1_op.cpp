...
using hls::sim::Byte;
extern "C" void hw5_ex1_op(Byte<4>*, Byte<4>*);
extern "C" void apatb_hw5_ex1_op_hw(volatile void * __xlx_apatb_param_A, volatile void * __xlx_apatb_param_B) {
...
__xlx_B__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_B)[i]);
  ...
  int __xlx_size_param_B = 30;
  int __xlx_offset_param_B = 0;
  int __xlx_offset_byte_param_B = 0*4;
  // DUT call
  hw5_ex1_op(__xlx_A__tmp_vec.data(), __xlx_B__tmp_vec.data());
