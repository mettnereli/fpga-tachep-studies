...
using hls::sim::Byte;
extern "C" void hw5_ex1(Byte<4>*, Byte<4>*);
extern "C" void apatb_hw5_ex1_hw(volatile void * __xlx_apatb_param_A, volatile void * __xlx_apatb_param_B) {
...
__xlx_B__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_B)[i]);
  ...
  // DUT call
  hw5_ex1(__xlx_A__tmp_vec.data(), __xlx_B__tmp_vec.data());
